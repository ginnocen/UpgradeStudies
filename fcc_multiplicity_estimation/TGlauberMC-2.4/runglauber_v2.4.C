/*
 $Id: runglauber.C 124 2017-06-07 11:34:30Z loizides $

 Copyright 2014 C. Loizides, J. Nagle, P. Steinberg
 see http://tglaubermc.hepforge.org/
 Latest writeup on arXiv, see http://arxiv.org/abs/1408.2549
...
public:
  ...
  Double_t      GetBNN()             const {return fBNN;}
  ...
  static const char *Version()             {return "v2.5";}
